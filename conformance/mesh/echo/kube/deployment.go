...
func GenerateDeployment(ctx resource.Context, cfg echo.Config) (string, error) {
	params, err := deploymentParams(ctx, cfg)
	if err != nil {
		return "", err
	}
...
func deploymentParams(ctx resource.Context, cfg echo.Config) (map[string]any, error) {
