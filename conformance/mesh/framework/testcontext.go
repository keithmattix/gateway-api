...
type TestContext interface {
	...
	NewSubTest(name string) suite.ConformanceTest
	NewSubTestf(format string, a ...any) suite.ConformanceTest
...
func newTestContext(test *suite.ConformanceTest, goTest *testing.T, s *suiteContext, parentScope *scope, labels label.Set) *testContext {
...
func (c *testContext) newChildContext(test *suite.ConformanceTest) *testContext {
